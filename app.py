...
app = Flask(__name__)
CORS(app, resources={r"/api/*": {"origins": ["http://localhost:8000", "http://localhost:3000", "https://tripvaults.com", "https://www.tripvaults.com", "*"], "methods": ["GET", "POST", "OPTIONS"], "allow_headers": ["Content-Type"]}})
